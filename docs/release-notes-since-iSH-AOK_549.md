...
- **The Linux CI builds again.** Twelve fixes, one root cause: bash's
  ...
  declaration are all Darwin spellings. Each was hidden behind the one before
  it, which is why they came out one at a time.
