...
needs_root_tests=" at_empty_path ambient_caps chroot_getcwd file_perms fsopen_move_mount fuse_basic fuse_threaded_daemon mount_bind_rbind mount_flags netlink_audit oom_score_adj uts_namespace "
