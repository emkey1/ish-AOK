...
if [ "$is_x86_guest" -eq 1 ]; then
    ...
    need_file x86/atomic_neg_not.c
    ...
    need_file x86/gpf_siginfo.c
    need_file x86/cpuid_xsave.c
    need_file x86/fpu_state_span.c
    need_file x86/x86_smc.c
    need_file x86/x86_smc_alias.c
    need_file x86/x86_fp_env.c
    need_file x86/cpuid_signature.c
    need_file x86/popf_ac_id.c
    need_file x86/null_deref_siginfo.c
    need_file x86/smc_patch_race.c
    need_file x86/x86_prefetch.c
    need_file x86/x86_ud_siginfo.c
fi
if [ "$is_x86_guest" -eq 1 ] && [ "$is_amd64_guest" -eq 0 ]; then
    need_file x86/i386_push16.c
    need_file x86/i386_enter_branch16.c
...
if [ "$is_arm64_guest" -eq 1 ]; then
    ...
    need_file arm64/arm64_fp_env.c
fi
...
need_file epoll_edge_triggered.c
need_file ptrace_exit_kill.c
need_file ptrace_tracee_exit.c
need_file ptrace_strace_startup.c
need_file ptrace_startup_with_shell.c
need_file ptrace_poke_text.c
need_file ptrace_pokeuser.c
need_file mlock_accounting.c
...
need_file mountinfo_tree.c
need_file mount_bind_id.c
need_file mount_bind_getpath.c
need_file inotify_bind_alias.c
need_file mount_bind_busy.c
need_file chroot_dotdot.c
need_file proc_net_socket_ids.c
need_file mount_lazy_detached.c
need_file exec_link_by_fd.c
need_file exec_fd_pathless.c
need_file tmpfs_nlink.c
need_file unix_dgram_cred.c
need_file unix_abstract_release.c
need_file unix_path_name_release.c
need_file unix_sock_host_isolation.c
need_file unix_bind_dir_perms.c
need_file unix_seqpacket_msgs.c
...
need_file mem_vsz_rss_peaks.c
need_file meminfo_scaling.c
...
need_file setns_join.c
need_file xattr_ops.c
need_file file_caps_exec.c
need_file rseq_register.c
need_file mqueue_ops.c
need_file ipc_namespace.c
...
need_file reparent_to_sibling_thread.c
need_file pdeath_signal.c
need_file wait_clone_child.c
need_file notify_parent_cldstop.c
need_file subreaper_not_inherited.c
need_file reparent_zombie_disposition.c
need_file wait_child_order.c
...
need_file proc_read_snapshot.c
need_file proc_pid_exit_race.c
...
need_file fs_chgrp_membership.c
need_file fs_ctime_updates.c
need_file proc_ptrace_access.c
need_file seccomp_filter.c
need_file rlimit_enforce.c
need_file nx_enforce.c
need_file aslr_layout.c
...
need_file timer_lateness.c
need_file timer_rearm_wake.c
need_file timer_missed_periods.c
need_file itimer_prof_rate.c
need_file timer_thread_cpu_early.c
...
need_file signal_ignored_restart.c
need_file signal_process_wake_one.c
need_file wake_mask_isolation.c
need_file host_port_leak.c
need_file signal_handler_mask.c
need_file signal_dequeue_order.c
need_file sigwait_kill.c
...
need_file unix_recv_name.c
need_file x86_unaligned_lock.c
need_file epoll_nested.c
need_file tmpfs_exec.c
need_file kcmp.c
need_file procfd_reopen.c
need_file proc_link_deleted.c
need_file opath_open_flags.c
need_file sysfs_cpu_topology.c
need_file cpu_count_agree.c
need_file sysfs_power_supply.c
need_file proc_ish_arch.c
need_file proc_ish_host_state.c
need_file stack_guard_gap.c
need_file stack_rlimit_pushdown.c
need_file realfs_long_name.c
need_file realfs_shared_owner.c
need_file setsid_thread_group.c
need_file group_signal_target.c
need_file signal_sender_tgid.c
need_file syscall_page_past_eof.c
...
# Files outside the test's own source that a test #includes and so must key
# its binary: without them, an edit to the included file is served the
# binary built from the old one -- which is how pixman_shim.c, compiling the
# guest's copy of the accelerator shim into itself, first came out stale.
extra_key_files_for() {
    case "$1" in
        pixman_shim)
...
cache_path_for() {
    ...
    _h=$(cat "$2" $(extra_key_files_for "$1") 2>/dev/null | sha256sum | cut -c1-32)
...
all_tests="signal_core fp_env signal_restart signal_restart_coverage signal_restart_record signal_ignored_restart signal_process_wake_one wake_mask_isolation host_port_leak signal_handler_mask signal_dequeue_order sigwait_kill signal_stop_restart utimensat_omit creds_groups_access sock_optlen inotify_events posix_timer_exec sock_options ptrace_attach inet_nat_bind signal_process_target exec_de_thread jit_writer_starvation tty_hangup_signal create_eexist_first fs_create_trailing_slash fs_open_creat_isdir fs_symlink_trailing_slash fs_final_dot_order fs_nofollow_trailing_slash fs_linkat_flags fs_chown_no_change fs_chown_kills_privs fs_chgrp_membership fs_ctime_updates proc_ptrace_access seccomp_filter rlimit_enforce nx_enforce aslr_layout sigchld_disposition proc_conformance fcntl_lock_validation tty_line_discipline tty_ctty_ioctls tty_job_control mmap_validation madvise_lazy_reservation mmap_lazy_split_commit mmap_hole_scaling mmap_shared_integrity fs_permission_rules fs_remove_enoent_order fs_at_validation sock_conformance_opts poll_rdhup_bounds poll_shutwr_dgram poll_default_mask poll_idle_cpu wake_poke_lost mem_guard_small_growth exec_perm_rules exec_shebang_interpreter exec_empty_env_string exec_cred_ids syslog_read_blocks syslog_read_clear kmsg_stream kmsg_records resource_limits_sched signal_routing_perms mounts_list_race sysctl_write_rules fallocate_modes openat2_resolve splice_vmsplice privs_syscall_misc timeout_and_cpu_timer open_tmpfile mount_flag_perms sgid_inherit sockopt_conventions tty_canon_queue timer_conventions timer_lateness timer_rearm_wake timer_thread_cpu_early timer_missed_periods itimer_prof_rate mmap_conventions fd_conventions proc_files signal_conventions dir_tmpfs futex_validation futex_timeout_duration orphan_pgrp_wait reparent_zombie_notify reparent_to_sibling_thread pdeath_signal wait_clone_child notify_parent_cldstop subreaper_not_inherited reparent_zombie_disposition wait_child_order fork_tgroup_reset rusage_monotonic dirfd_position cross_process_state concurrent_dir_futex sock_bind_refuse time_clocks_ticks futex_robust_requeue futex_shared_mapping inotify_mask_queue time_conformance signal_realtime signal_altstack signal_stop_cont signal_forced_trap signal_poll signal_child_burst eventfd_interrupt futex_core process_lifecycle pthread_sync ptrace_group_stop ptrace_group_stop_report ptrace_trap_siginfo swap_roundtrip zswap_roundtrip zswap_fork_cow zram_idle_reclaim ptrace_thread_follow ptrace_detach_survives ptrace_eventmsg ptrace_stop_races ptrace_stop_restart ptrace_seize_trap_stop ptrace_spinning_thread epoll_mod_wake epoll_oneshot_rearm epoll_mod_spurious_wake epoll_data_layout epoll_eloop epoll_exclusive epoll_dup_add epoll_edge_triggered ptrace_exit_kill ptrace_tracee_exit ptrace_strace_startup ptrace_startup_with_shell ptrace_poke_text ptrace_pokeuser mlock_accounting fcntl_lock fcntl_ofd fcntl_setown at_empty_path at_absolute_path utimensat_fd copy_file_range name_to_handle_at sendfile_vhangup pidfd_open pidfd_zombie pidfd_clone pidfd_fdinfo_pid fsopen_move_mount keyctl_link mountinfo_epollet mountinfo_tree mount_bind_id mount_bind_getpath mount_bind_busy chroot_dotdot proc_net_socket_ids mount_lazy_detached exec_link_by_fd exec_fd_pathless tmpfs_accmode tmpfs_nlink unix_dgram_cred unix_abstract_release unix_path_name_release unix_sock_host_isolation unix_bind_dir_perms unix_seqpacket_msgs ambient_caps scm_rights_stress scm_rights_pidfd fs_conformance process_conformance time_conformance mem_conformance mem_vsz_rss_peaks meminfo_scaling sock_conformance getpeername_smallbuf netlink_route netlink_audit netlink_blocking_recv sock_timeo_eintr mount_flags mount_bind_rbind fuse_basic fuse_threaded_daemon native_stdio_lock devtmpfs_mount clone_error_cleanup uts_namespace setns_join xattr_ops file_caps_exec rseq_register mqueue_ops ipc_namespace posix_timer_fork vfork_fatal_signal vfork_exec_stale_jit getppid_thread concurrent_exec_tlb exec_i386_fault_addr native_exec_cloexec native_ptrace_group_stop random_seed getrusage_group proc_pid_stat_cputime pty_line_discipline proc_pid_io taskstats_genl acct_records tmpfs_mmap tmpfs_statfs tmpfs_append memfd_mmap mount_stdev mount_cross_dev mount_fake_long_source cgroup2_rmdir mmap_truncate_sigbus null_page_fault signalfd_epoll_deadlock pidfd_epoll_deadlock signalfd_thread_group wayland_scm_shm chroot_getcwd iovec_abi_marshal fakefs_type_race fakefs_casefold fakefs_inode_alias fifo_open_creat_deadlock proc_stat_monotonic proc_uptime_clock clock_boot_origin vdso_clock proc_loadavg_rises blocked_wait_state proc_readdir_tgid proc_field_layout proc_cmdline_environ proc_read_snapshot proc_pid_exit_race sock_conn_error sock_getfd_errno sock_nosignal inotify_close_race inotify_mount_paths inotify_bind_alias inotify_fionread statx_mnt_id_timerfd timerfd_settime_readiness opath_symlink_pidfd_wait pidfd_self_exit_deadlock prctl_capbset_drop oom_score_adj sysv_ipc shm_rmid_attach accept_rcvtimeo accept_herd_single_winner accept_kill socket_kill inaddr_any_iface procfd_reopen opath_open_flags proc_link_deleted siocoutq sock_ifconf_sizing signal_group_blocked_eintr scm_credentials_rules unix_scm_before_accept unix_recv_name x86_unaligned_lock epoll_nested tmpfs_exec kcmp pixman_accel pixman_shim aes_gcm_accel file_perms ftruncate_fd_mode syscall_wiring sysfs_cpu_topology cpu_count_agree sysfs_dev_ns sysfs_power_supply proc_ish_arch proc_ish_host_state stack_guard_gap stack_rlimit_pushdown realfs_long_name realfs_shared_owner setsid_thread_group group_signal_target signal_sender_tgid syscall_page_past_eof"
if [ "$is_x86_guest" -eq 1 ]; then
    # x86 flag-semantics atomics (lock-prefixed inline asm)
    all_tests="rep_interruptible atomic_xadd32 atomic_cmpxchg32 atomic_cmpxchg8b atomic_logic32 atomic_lock_contended atomic_neg_not cow_atomic_fault x87_fpu x86_loop port_io_gpf gpf_siginfo cpuid_xsave cpuid_signature fpu_state_span x86_smc popf_ac_id null_deref_siginfo smc_patch_race x86_smc_alias x86_fp_env x86_ud_siginfo x86_prefetch $all_tests"
fi
if [ "$is_x86_guest" -eq 1 ] && [ "$is_amd64_guest" -eq 0 ]; then
    ...
    all_tests="avx32_smoke bcd_adjust i386_segment_regs i386_push16 i386_enter_branch16 $all_tests"
fi
if [ "$is_amd64_guest" -eq 1 ]; then
...
needs_root_tests=" at_empty_path fs_ctime_updates ambient_caps chroot_dotdot chroot_getcwd file_perms fsopen_move_mount fuse_basic fuse_threaded_daemon inotify_bind_alias mount_bind_getpath mount_bind_busy mount_bind_id mount_bind_rbind mount_fake_long_source mount_flags mount_lazy_detached exec_link_by_fd exec_fd_pathless tmpfs_accmode netlink_audit oom_score_adj realfs_long_name sysfs_dev_ns uts_namespace setns_join file_caps_exec ipc_namespace futex_shared_mapping "
