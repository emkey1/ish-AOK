...
needs_root_tests=" at_empty_path ambient_caps chroot_dotdot chroot_getcwd file_perms fsopen_move_mount fuse_basic fuse_threaded_daemon inotify_bind_alias mount_bind_getpath mount_bind_busy mount_bind_id mount_bind_rbind mount_fake_long_source mount_flags mount_lazy_detached netlink_audit oom_score_adj realfs_long_name sysfs_dev_ns uts_namespace file_caps_exec ipc_namespace "
